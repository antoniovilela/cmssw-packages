...
void PFlowNoiseAnalyzer::beginJob(){
  ...
  int nBinsEnergy = 200;
  histosTH2F_["energyVsEtaAllTypes"] = fs->make<TH2F>("energyVsEtaAllTypes","energyVsEtaAllTypes",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaUndefined"] = fs->make<TH2F>("energyVsEtaUndefined","energyVsEtaUndefined",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaChargedHadron"] = fs->make<TH2F>("energyVsEtaChargedHadron","energyVsEtaChargedHadron",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaElectron"] = fs->make<TH2F>("energyVsEtaElectron","energyVsEtaElectron",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaMuon"] = fs->make<TH2F>("energyVsEtaMuon","energyVsEtaMuon",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaGamma"] = fs->make<TH2F>("energyVsEtaGamma","energyVsEtaGamma",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaNeutralHadron"] = fs->make<TH2F>("energyVsEtaNeutralHadron","energyVsEtaNeutralHadron",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaHadronHF"] = fs->make<TH2F>("energyVsEtaHadronHF","energyVsEtaHadronHF",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
  histosTH2F_["energyVsEtaEGammaHF"] = fs->make<TH2F>("energyVsEtaEGammaHF","energyVsEtaEGammaHF",41,etaBinsHCALBoundaries,nBinsEnergy,energyMin,energyMax);
