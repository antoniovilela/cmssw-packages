...
process.modulo1.inputFile = cms.untracked.string('@@INPUTFILE@@')
...
process.modulo2.inputFile = cms.untracked.string('@@INPUTFILE@@')
...
process.modulo3.inputFile = cms.untracked.string('@@INPUTFILE@@')
process.modulo3.OutputFileName = cms.string('@@OUTPUTFILE@@')
