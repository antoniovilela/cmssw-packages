...
ExclusiveDijetsAnalysisImpl::ExclusiveDijetsAnalysisImpl(const edm::ParameterSet& pset):
...
void ExclusiveDijetsAnalysisImpl::fillPileUpInfo(EventData& eventData, const edm::Event& event, const edm::EventSetup& setup){
...
void ExclusiveDijetsAnalysisImpl::fillVertexInfo(EventData& eventData, const edm::Event& event, const edm::EventSetup& setup){
...
void ExclusiveDijetsAnalysisImpl::fillJetInfo(EventData& eventData, const edm::Event& event, const edm::EventSetup& setup){
...
template <class Coll>
std::pair<double,double> ExclusiveDijetsAnalysisImpl::xi(Coll& partCollection, bool useJetCorr){
...
double ExclusiveDijetsAnalysisImpl::Rjj(JetColl& jetCollection,PartColl& partCollection){
  math::XYZTLorentzVector dijetSystem(0.,0.,0.,0.);
...
unsigned int ExclusiveDijetsAnalysisImpl::nHFSlice(const std::map<unsigned int, std::vector<unsigned int> >& mapTreshToiEta, unsigned int thresholdHF, unsigned int ieta){
